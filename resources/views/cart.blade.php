                ...
                <table class="table" cellspacing="0">
                    ...
                    <tbody>
                        <tr class="">
                            ...
                            <td data-title="Price">
                                <span class="">
                                    <div class="d-flex align-items-center"><img src="{{  asset('assets/img/dihram.webp') }}" height="20" width="20" />100.00</div>
                                </span>
                            </td>
                        ...
                        <tr class="">
                            ...
                            <td data-title="Price">
                                <span class="">
                                    <div class="d-flex align-items-center"><img src="{{  asset('assets/img/dihram.webp') }}" height="20" width="20" />85.00</div>
                                </span>
                            </td>
                            ...
                            <td colspan="6" class="border-top space-top-2 justify-content-center">
                                <div class="pt-md-3">
                                    <div class="d-block d-md-flex flex-center-between">
                                        ...
                                        <div class="d-md-flex">
                                            <a href="{{ route(\App\Constants\RouteNames::CART) }}" class="btn btn-soft-secondary mb-3 mb-md-0 font-weight-normal px-5 px-md-4 px-lg-5 w-100 w-md-auto">Update cart</a>
                                            <a href="{{ route(\App\Constants\RouteNames::CHECKOUT) }}" class="btn btn-primary-dark-w ml-md-2 px-5 px-md-4 px-lg-5 w-100 w-md-auto d-none d-md-inline-block">Proceed to checkout</a>
                                        </div>
                                    </div>
                                </div>
                            </td>
