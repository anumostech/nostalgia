                ...
                <div class="container">
                    <div class="d-flex align-items-center">
                        <div class="topbar-left">
                            <a href="#" class="text-gray-110 font-size-13 u-header-topbar__nav-link">Nostalgia Sweets |
                                Flavors That Feel Like Home</a>
                        </div>
                            ...
                            <ul class="list-inline mb-0">
                                <li
                                    ...
                                    <a href="#" class="u-header-topbar__nav-link"><i class="ec ec-map-pointer mr-1"></i>
                                        Al Sajaah Industrial Area-Sharjah</a>
                                </li>
                                <li
                                    class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border">
                                    <a href="{{ route(\App\Constants\RouteNames::TRACK_YOUR_ORDER) }}"
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="position-relative">
                                            <a id="languageDropdownInvoker"
                                                class="dropdown-nav-link dropdown-toggle d-flex align-items-center u-header-topbar__nav-link font-weight-normal no-arrow"
                                                ...
                                                <span class="d-none d-sm-inline-flex align-items-center">
                                                    <div class="d-flex align-items-center"><img
                                                            src="{{  asset('assets/img/dihram.webp') }}" height="20"
                                                            width="20" /></div>
                                                </span>
                                            </a>
                                ...
                                <li
                                    class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border">
                                    @guest
                                        <a href="{{ route(\App\Constants\RouteNames::LOGIN) }}"
                                    ...
                                    @endguest
                                    @auth
                                        <a href="{{ route(\App\Constants\RouteNames::MY_ACCOUNT) }}"
                                            class="u-header-topbar__nav-link">
                        ...
                        <div class="col-auto">
                            ...
                            <nav
                                ...
                                <a class="order-1 order-xl-0 navbar-brand u-header__navbar-brand u-header__navbar-brand-center"
                                    href="{{ route(\App\Constants\RouteNames::HOME) }}" aria-label="Electro">
                                            ...
                                            <div class="js-scrollbar u-sidebar__body">
                                                <div id="headerSidebarContent"
                                                    ...
                                                    <a class="d-flex ml-0 navbar-brand u-header__navbar-brand u-header__navbar-brand-vertical"
                                                        href="{{ route(\App\Constants\RouteNames::HOME) }}"
                                                        aria-label="Electro">
                                                    ...
                                                    <ul id="headerSidebarList" class="u-header-collapse__nav">
                                                        ...
                                                        <li class="u-has-submenu u-header-collapse__submenu">
                                                            <a class="u-header-collapse__nav-link u-header-collapse__nav-pointer  no-arrow"
                                                                href="{{ route(\App\Constants\RouteNames::HOME) }}"
                                                        ...
                                                        <li class="u-has-submenu u-header-collapse__submenu">
                                                            <a class="u-header-collapse__nav-link u-header-collapse__nav-pointer"
                                                                href="{{ route(\App\Constants\RouteNames::PRODUCT_LIST) }}"
                                                                ...
                                                                <ul id="headerSidebarBlogMenu"
                                                                    ...
                                                                    @foreach($categories as $category)
                                                                        ...
                                                                        <li><a class="u-header-collapse__nav-link"
                                                                                href="{{ route(\App\Constants\RouteNames::CATEGORY_SHOW, ['category_id' => $category->id]) }}">{{ $category->name }}</a>
                                                                        </li>
                                                        ...
                                                        <li class="u-has-submenu u-header-collapse__submenu">
                                                            <a class="u-header-collapse__nav-link u-header-collapse__nav-pointer no-arrow"
                                                                href="{{ route(\App\Constants\RouteNames::ABOUT) }}"
                                                        ...
                                                        <li class="u-has-submenu u-header-collapse__submenu">
                                                            <a class="u-header-collapse__nav-link u-header-collapse__nav-pointer no-arrow"
                                                                href="{{ route(\App\Constants\RouteNames::CONTACT) }}"
                                                                data-target="#headerSidebarPagesCollapse" role="button"
                                                                aria-expanded="false"
                                                                aria-controls="headerSidebarPagesCollapse">
                                                                Contact Us
                                                        ...
                                                        <li class="u-has-submenu u-header-collapse__submenu">
                                                            <a class="u-header-collapse__nav-link u-header-collapse__nav-pointer no-arrow"
                                                                href="{{ route(\App\Constants\RouteNames::FAQ) }}"
                                                        ...
                                                        <li class="u-has-submenu u-header-collapse__submenu">
                                                            <a class="u-header-collapse__nav-link u-header-collapse__nav-pointer no-arrow"
                                                                href="{{ route(\App\Constants\RouteNames::PRIVACY) }}"
                                                        ...
                                                        <li class="u-has-submenu u-header-collapse__submenu">
                                                            <a class="u-header-collapse__nav-link u-header-collapse__nav-pointer no-arrow"
                                                                href="{{ route(\App\Constants\RouteNames::TERMS_AND_CONDITIONS) }}"
                            ...
                            <form class="js-focus-state">
                                ...
                                <div class="input-group">
                                    <input type="email"
                                        ...
                                        placeholder="Search your favorite childhood sweets…"
                                        aria-label="Search your favorite childhood sweets…"
                            ...
                            <div class="d-inline-flex">
                                <ul class="d-flex list-unstyled mb-0 align-items-center">
                                    ...
                                    <li class="col d-xl-none px-2 px-sm-3"><a
                                            href="{{ route(\App\Constants\RouteNames::MY_ACCOUNT) }}"
                                ...
                                <ul class="navbar-nav u-header__navbar-nav">
                                    ...
                                    <li class="nav-item hs-has-mega-menu u-header__nav-item" data-event="hover"
                                        ...
                                        <a id="homeMegaMenu"
                                            ...
                                            href="{{ route(\App\Constants\RouteNames::HOME) }}" aria-haspopup="true"
                                            ...
                                            <div class="row u-header__mega-menu-wrapper">
                                                <div class="col-md-3">
                                                    ...
                                                    <ul class="u-header__sub-menu-nav-group">
                                                        <li><a href="{{ route(\App\Constants\RouteNames::HOME) }}"
                                                                class="nav-link u-header__sub-menu-nav-link">Home</a>
                                                        </li>
                                                        <li><a href="{{ route(\App\Constants\RouteNames::ABOUT) }}"
                                                                class="nav-link u-header__sub-menu-nav-link">About
                                                                Us</a></li>
                                                        <li><a href="{{ route(\App\Constants\RouteNames::CONTACT) }}"
                                                                class="nav-link u-header__sub-menu-nav-link">Contact
                                                                Us</a></li>
                                                        <li><a href="{{ route(\App\Constants\RouteNames::FAQ) }}"
                                                                class="nav-link u-header__sub-menu-nav-link">FAQ</a>
                                                        </li>
                                                        <li><a href="{{ route(\App\Constants\RouteNames::PRIVACY) }}"
                                                                class="nav-link u-header__sub-menu-nav-link">Privacy</a>
                                                        </li>
                                                        <li><a href="{{ route(\App\Constants\RouteNames::TERMS_AND_CONDITIONS) }}"
                                                                class="nav-link u-header__sub-menu-nav-link">Terms Of
                                                                Use</a></li>
                                                    </ul>
                                                </div>
                                                <div class="col-md-3">
                                                    ...
                                                    <ul class="u-header__sub-menu-nav-group">
                                                        @foreach($categories as $category)
                                                            <li><a href="{{ route(\App\Constants\RouteNames::CATEGORY_SHOW, ['category_id' => $category->id]) }}"
                                                                    class="nav-link u-header__sub-menu-nav-link">{{ $category->name }}</a>
                                                            </li>
                                                        @endforeach
                                                    </ul>
                                                </div>
                                                <div class="col-md-3">
                                                    <a href="{{ route(\App\Constants\RouteNames::PRODUCT_LIST) }}"
                                                        class="d-block mb-3">
                                                        <img class="img-fluid"
                                                            src="{{ asset('assets/img/products/11.png') }}"
                                                ...
                                                <div class="col-md-3">
                                                    <a href="{{ route(\App\Constants\RouteNames::PRODUCT_LIST) }}"
                                                        class="d-block mb-3">
                                                        <img class="img-fluid"
                                                            src="{{ asset('assets/img/products/12.png') }}"
                                                            alt="Image Description">
                                                    </a>
                                                </div>
                                            </div>
