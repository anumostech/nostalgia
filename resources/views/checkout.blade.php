                        ...
                        <div class="bg-gray-1 rounded-lg">
                            ...
                            <div class="p-4 mb-4 checkout-table">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr class="cart_item">
                                            <td>LEMON CANDY BTL (4*40)&nbsp;<strong class="product-quantity">× 1</strong></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="d-flex align-items-center"><img src="{{  asset('assets/img/dihram.webp') }}" height="15" width="15" />100.00</div>
                                            </td>
                                        </tr>
                                        <tr class="cart_item">
                                            <td>PEANUT CHIKKI CANDY (200PCS)&nbsp;<strong class="product-quantity">× 1</strong></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="d-flex align-items-center"><img src="{{  asset('assets/img/dihram.webp') }}" height="15" width="15" />85.00</div>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="d-flex align-items-center"><img src="{{  asset('assets/img/dihram.webp') }}" height="15" width="15" />785.00</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Shipping</th>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="js-form-message mb-6">
                                    ...
                                    <input type="text" class="form-control" name="firstName" placeholder="First name" aria-label="" required="" data-msg="Please enter your frist name." data-error-class="u-has-error" data-success-class="u-has-success" autocomplete="off">
                                </div>
                                <!-- End Input -->
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="js-form-message mb-6">
                                    ...
                                    <input type="text" class="form-control" name="lastName" placeholder="Last name" aria-label="" required="" data-msg="Please enter your last name." data-error-class="u-has-error" data-success-class="u-has-success">
                                </div>
                                <!-- End Input -->
                            </div>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="js-form-message mb-6">
                                    ...
                                    <input type="text" class="form-control" name="streetAddress" placeholder="Street Address" aria-label="" required="" data-msg="Please enter a valid address." data-error-class="u-has-error" data-success-class="u-has-success">
                                </div>
                                <!-- End Input -->
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="js-form-message mb-6">
                                    ...
                                    <input type="text" class="form-control" name="cityAddress" placeholder="City" aria-label="" required="" data-msg="Please enter a valid address." data-error-class="u-has-error" data-success-class="u-has-success" autocomplete="off">
                                </div>
                                <!-- End Input -->
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="js-form-message mb-6">
                                    ...
                                    <input type="text" class="form-control" name="Postcode" placeholder="Postcode" aria-label="" required="" data-msg="Please enter a postcode or zip code." data-error-class="u-has-error" data-success-class="u-has-success">
                                </div>
                                <!-- End Input -->
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="js-form-message mb-6">
                                    ...
                                    <input type="email" class="form-control" name="emailAddress" placeholder="Email" aria-label="Email" required="" data-msg="Please enter a valid email address." data-error-class="u-has-error" data-success-class="u-has-success">
                                </div>
                                <!-- End Input -->
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="js-form-message mb-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Phone" aria-label="Phone" data-msg="Please enter your last name." data-error-class="u-has-error" data-success-class="u-has-success">
                                </div>
                                <!-- End Input -->
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="js-form-message mb-6">
                                                ...
                                                <input type="text" class="form-control" name="streetAddress" placeholder="Address" aria-label="" required="" data-msg="Please enter a valid address." data-error-class="u-has-error" data-success-class="u-has-success">
                                            </div>
                                            <!-- End Input -->
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="js-form-message mb-6">
                                                ...
                                                <input type="text" class="form-control" name="Postcode" placeholder="Postcode" aria-label="99999" required="" data-msg="Please enter a Postcode or zip code." data-error-class="u-has-error" data-success-class="u-has-success">
                                            </div>
                                            <!-- End Input -->
                                        </div>
