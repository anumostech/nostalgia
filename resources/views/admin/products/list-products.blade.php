                                    ...
                                    <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><div class="d-flex align-items-center"><img src="{{  asset('assets/img/dihram.webp') }}" height="15" width="15" /><span>{{ number_format($product->price ?? 0, 2) }}</span></div></td>
                                                    ...
                                                    <div class="hstack gap-2 justify-content-end">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item" href="{{ route(\App\Constants\RouteNames::PRODUCT_EDIT, $product->id) }}">
