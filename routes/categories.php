...
Route::prefix('administrator')->middleware('auth')->group(function () {
    ...
    Route::prefix('categories')->group(function () {
        ...
        Route::get('/edit/{id}', [CategoryController::class, 'editCategory'])->name(RouteNames::CATEGORY_EDIT);
        Route::post('/update/{id}', [CategoryController::class, 'updateCategory'])->name(RouteNames::CATEGORY_UPDATE);
        Route::post('/delete/{id}', [CategoryController::class, 'deleteCategory'])->name(RouteNames::CATEGORY_DELETE);
    });
});
